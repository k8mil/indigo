...
It could be a lane for: compile your project and run unit tests or just compile a project or compile a project then create .ipa files and send it to iTunesConnect or even separated lane for running UI tests.
...
![failure condition](./teamcity-for-ios-project/install_build_agent.png)

I prefer a way to install it via `Zip file distribution`. After you click on that your web browser will download all the files that are necessary to run agent.
...
TeamCity is a great platform to provide Continuous Integration in your project. In combination with Fastlane it saves you a many hours of manual deploying, testing, compiling.
